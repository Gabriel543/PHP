<?php 
    include './header.php';
    include './consulta_disciplina.php';
?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!--
                     ...
                     -->
                    <td><span data-toggle="modal" data-target="#disciplinaModal" data-disciplina_id="<?= $disciplina['id_disciplina'] ?>" data-disciplina_name="<?= $disciplina['nome'] ?>" data-disciplina_description="<?= $disciplina['descricao'] ?>"><i class="fas fa-edit text-primary"></i></span></td>
                    <td><a href="delete_disciplina.php?id=<?= $disciplina['id_disciplina'] ?>" onclick="return confirm('Você tem certeza?')"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
