<?php 
    ...
    include_once './consulta_curso.php';
?>
        ...
        <table class="table table-striped table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $curso['nome'] ?></td>
                    <td><span data-toggle="modal" data-target="#cursoModal" class="" data-curso_id="<?= $curso['id_curso'] ?>" data-curso_name="<?= $curso['nome'] ?>" data-product-quantity="1"><i class="fas fa-edit text-primary"></i></span></td>
                        ...
                        <fieldset>
                            <form id="edit_form" action="edit_curso.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="id_nome" name="txtNome" placeholder="Informe o nome" class="form-control" required>
                                </div>
                            </form>
                        </fieldset>
                    </div>
