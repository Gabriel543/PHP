<?php 
    include './header.php';
    include './consulta_professor.php';
?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!--
                     ...
                     -->
                    <td><span data-toggle="modal" data-target="#professorModal" class="" data-professor_id="<?= $professor['id_professor'] ?>" data-professor_name="<?= $professor['nome'] ?>" data-professor_cpf="<?= $professor['cpf'] ?>" data-professor_telefone="<?= $professor['telefone'] ?>"><i class="fas fa-edit text-primary"></i></span></td>
                    <td><a href="delete_professor.php?id=<?= $professor['id_professor'] ?>" onclick="return confirm('Você tem certeza?')"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
